...
model{
 ...
 //Prior on conf
  ...
  for (k in 1:nnz_mips24) {
    db_hat_mips24[Row_mips24[k]+1] <- db_hat_mips24[Row_mips24[k]+1] + Val_mips24[k]*f_vec[Col_mips24[k]+1][1];
      }
  ...
  for (k in 1:nnz_plw) {
    db_hat_lb850[Row_lb850[k]+1] <- db_hat_lb850[Row_lb850[k]+1] + Val_lb850[k]*f_vec[Col_lb850[k]+1][7];
      }
